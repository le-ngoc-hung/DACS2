    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center px-5">
                <h2 class="text-primary ">Thông tin nhà tuyển dụng</h2> <br>
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <input type="text" name="name" value="<?php echo $company->getName() ?>" style="width:76%; margin-left:80px; padding:10px;">
                    </div>
                    <div class="mb-3 mt-4">
                        <label for=""><b>Mô tả</b></label>
                        <textarea name="des" id="" style="width:76%; margin-left:60px; height:120px; padding:10px;"><?php echo $company->getDes() ?></textarea>
                    </div>
                    <div class="mt-5">
